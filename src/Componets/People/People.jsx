...
import Typedtp from "./Typedtp/Typedtp";

export default function People() {
  
  const [ApiPeople, setApiPeople] = useState(null)
  async function getApiPeople() {
  ...
  return <>
  {ApiPeople===null?<div className=" bg-dark vh-100 d-flex justify-content-center  align-items-center">
      <i class="fa-solid fa-spinner fa-spin-pulse fa-spin-reverse text-white fa-6x"></i>
    </div>:<div className="bg-dark py-5">
        <h1 className=" text-white text-center"><Typedtp/></h1>
      <div className="container  text-center  text-white mt-5 ">

        <div className="row gy-4">
          {ApiPeople.map(function (item, index) {
            return (
              <div key={index} className=" col-md-4">
                <div className="itemcard shadow   rounded rounded-3">
                  <div className=" position-relative overflow-hidden">
                    {item.profile_path===null? <img
                      className="w-100"
                      src={require("../../images/images (2).jpeg")}
                      alt=""
                    />: <img
                    className="w-100"
                    src={
                  ...
                  />}
                    ...
                    <div className="py-5 p-2 itemoverview d-flex justify-content-center align-items-center">
                      {item.known_for_department === "" ? (
                        <p>
                          known_for_department: sit amet consectetur
                         
                        </p>
                      ) : (
                        <p>known_for_department: {item.known_for_department.slice(0, 100)}</p>
                      )}
                    </div>
                  </div>
                  <div className=" pt-4">
