...
export default function Home() {
  ...
  async function getApiAllMovies() {
  ...
  return (
    <>
      {TrendingAll===null?<div className=" bg-dark vh-100 d-flex justify-content-center  align-items-center">
          <i class="fa-solid fa-spinner fa-spin-pulse fa-spin-reverse text-white fa-6x"></i>
        </div>:<div className="bg-dark py-5">
            <h1 className=" text-white text-center"><TypedComponent/></h1>
          <div className="container  text-center  text-white mt-5 ">

            <div className="row gy-4">
              {TrendingAll.map(function (item, index) {
                return (
